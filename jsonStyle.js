...
// 注释的话  从 /* 开始 到 */ 结束 
// 一个换行开始，到{之前的事选择器，然后{}之间的是key value，然后用;分割，然后用:分割，前面的是key，后面的是value
// 一个style是从一个换行开始 到 }结束 
// 注释中的参数用 {{}} 包裹
// style中的参数用 /**/ 包裹
...
fs.readFile('01.css', 'utf-8', function(err, data) {
    fs.writeFileSync('formatArr.js', 'var formatArr = ' + JSON.stringify(formatStyleString(data)), 'utf-8');
});
